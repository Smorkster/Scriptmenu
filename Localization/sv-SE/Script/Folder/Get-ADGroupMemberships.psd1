...
StrOutInfo3 = Vissa shares kan vara gamla och inte ens finnas längre etc.
StrOutPath = En lista över behörigheter har nu sparats i följande fil
StrOutTitle = har följande behörigheter, per behörighetstyp
StrOutTitleChange = Change-behörighet
